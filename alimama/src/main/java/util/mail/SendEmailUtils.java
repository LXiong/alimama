...
public class SendEmailUtils {
	...
	public static void main(String[] args) {
		String propValue = SendEmailUtils.getPropValue("mail.smtp.host");
		...
		String mailHost = "smtp.sina.com";// pu.getValue("mail.send.host");
		String mailEmail = "xiaomin0322@sina.com";// pu.getValue("mail.send.email");
		String mailUser = "xiaomin0322";// pu.getValue("mail.send.user");
		String mailPassword = "";// pu.getValue("mail.send.password");
		try {
			new SendEmailUtils().send("635674608@qq.com", mailEmail, "密码重置", content.toString(), mailHost, mailUser, mailPassword, false);
