...
public class HttpClientUtil {
     ...
     * @return 远程主机响应正文
     */
    public static String sendPostRequest(HttpPost httpPost, String sendData, boolean isEncoder, String encodeCharset, String decodeCharset){
    	return sendPostRequest(httpPost, sendData, isEncoder, encodeCharset, decodeCharset,null,null);
    }
    /**
     * 发送HTTP_POST请求
     * @see 该方法会自动关闭连接,释放资源
     ...
     * @return 远程主机响应正文
     */
    public static String sendPostRequest(HttpPost httpPost, String sendData, boolean isEncoder, String encodeCharset, String decodeCharset,HttpHost proxy,List<Cookie> cookies){
        String responseContent = null;
        //HttpClient httpClient = new DefaultHttpClient();
       ...
       // HttpPost httpPost = new HttpPost(reqURL);
        ...
        try{
            ...
            Header[] headers = response.getHeaders("set-cookie");
			 if(ArrayUtils.isNotEmpty(headers) && cookies!=null){
            ...
            logger.debug("与[" + httpPost + "]通信过程中发生异常,堆栈信息如下", e);
        }finally{
            httpClient.getConnectionManager().shutdown();
        }
        return responseContent;
