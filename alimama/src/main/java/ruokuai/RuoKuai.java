...
public class RuoKuai {
	...
	public static String getInfo(String username, String password) {
		...
		String result;
		try {
			result = RuoKuai.httpRequestData("http://api.ruokuai.com/info.xml",
					param);
		} catch (IOException e) {
			result = "未知问题";
		}
	...
	public static String createByUrl(String username, String password,
		...
		String param = String
				.format("username=%s&password=%s&typeid=%s&timeout=%s&softid=%s&softkey=%s",
		...
		try {
			...
			result = RuoKuai.httpPostImage("http://api.ruokuai.com/create.xml",
					param, data);
	 ...
	 * @throws IOException
	 */
	public static String report(String username, String password,
			String softid, String softkey, String id) {

		String param = String.format(
				"username=%s&password=%s&softid=%s&softkey=%s&id=%s", username,
				password, softid, softkey, id);
		String result;
		try {
			result = RuoKuai.httpRequestData(
					"http://api.ruokuai.com/reporterror.xml", param);
		} catch (IOException e) {
			result = "未知问题";
		}
