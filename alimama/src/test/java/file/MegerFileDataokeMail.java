...
public class MegerFileDataokeMail {
	...
	public static void main(String[] args)throws Exception {
		megerDataokeAndTaobao();
	}
	
	
	public static void megerDataokeAndTaobao()throws Exception{
        File dataoke = new File(base,"dataoke.txt");
		
		File mail = new File(base,"taobao.txt");
	...
	public static void megerDataokeAndMail()throws Exception{
         File dataoke = new File(base,"dataoke.txt");
